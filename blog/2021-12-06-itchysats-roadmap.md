...
When trading CFDs you use an underlying asset as collateral - Bitcoin in our case - to trade against an asset that can be valued in Bitcoin, but without actually holding said asset.
...
If you want to learn more about it we recommend this [good summary](https://bitcoinops.org/en/topics/discreet-log-contracts/) and the [dlcspecs repository](https://github.com/discreetlogcontracts/dlcspecs).
...
;; TODO: I think this is partially a copy-paste of above section TLDR
